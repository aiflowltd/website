    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 pt-32 pb-20">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold font-alternates mb-4">
            Terms of service
          </h1>
          <p className="text-grey mb-8">Last updated: December 18, 2021</p>
          ...
          <Card className="bg-card border-border p-8 md:p-12 space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-foreground">Disputes Resolution</h2>
              <p className="text-grey leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-foreground">Changes to These Terms of Service</h2>
              <p className="text-grey leading-relaxed mb-4">
            ...
            <section>
              ...
              <p className="text-grey leading-relaxed mt-2">
                By email: <a href="mailto:contact@aiflow.ltd" className="text-grey hover:text-foreground hover:underline">contact@aiflow.ltd</a>
              </p>
            </section>
          </Card>
        </div>
