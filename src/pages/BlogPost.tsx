...
const BlogPost = () => {
  ...
  const blogPosts: Record<string, any> = {
    "why-you-need-ai-consultant-2025": {
      ...
      excerpt:
        "Building impactful AI products requires rigorous fundamentals. Learn why bringing in an AI consultant is no longer a luxury but a strategic necessity.",
    ...
    "how-to-start-learning-ai-2025": {
      ...
      excerpt:
        "A practical guide for founders and tech leads on where to actually start learning AI, grounded in real-world experience building transformative AI systems.",
      authorId: "mihai-anton",
    ...
    "tech-giants-ai-acquisitions-2025": {
      ...
      excerpt:
        "Why large companies are on an AI buying spree and what smaller enterprises can learn from this strategic push to embed AI expertise into their business models.",
      authorId: "mihai-anton",
    ...
    "understanding-ai-agents": {
      ...
      excerpt:
        "Beyond the hype: what AI agents really are, how they differ from simple automation, and whether they'll reshape how businesses build AI-driven products.",
      authorId: "mihai-anton",
    ...
    "pruning-junk-tokens-llm-costs": {
      ...
      excerpt:
        "A practical guide to reducing your AI API bills by up to 85% through intelligent token pruning – and why this pattern works almost anywhere.",
      authorId: "mihai-anton",
        ...
        },
        {
          ...
          rows: [
            [
              ...
              "Quoted history, signatures, tracking pixels",
              "Strip previous replies; keep topmost message only",
            ],
            [
              "E-commerce product pages",
              "Carousels, ads, hidden SEO copy",
              "Extract canonical description, schema.org fields",
            ],
            [
              "Legal PDFs",
              "Headers, footers, Bates numbers",
              "Page-header detection, merge body text",
            ],
            [
              "Log files",
              "Timestamp boilerplate, debug stack traces",
              "Regex sponge before summarisation",
            ],
            [
              "Meeting transcripts",
              "Fillers, cross-talk, greetings",
              "ASR confidence > 0.9, remove <200ms utterances",
            ],
          ],
        },
        {
    ...
    "5-ways-improve-ml-system": {
      ...
      excerpt:
        "Behind every polished demo sits a messier truth. Fix these five low-hanging optimizations early to improve your system, prepare it for scale, and reduce costs.",
      authorId: "mihai-anton",
      ...
      image:
        "https://images.unsplash.com/photo-1527474305487-b87b222841cc?w=1200&h=600&fit=crop",
      content: [
        {
          type: "paragraph",
...
# Add alert rules for drift and GPU memory spikes`,
    ...
    "future-of-ai-enterprise-2025": {
      ...
      excerpt:
        "Explore the emerging AI trends that will shape enterprise technology in the coming year, from generative AI to autonomous systems.",
    ...
    "production-ml-pipelines": {
      ...
      excerpt:
        "Learn best practices for creating robust, scalable ML pipelines that can handle real-world production demands.",
      authorId: "irina-barbos",
...
with mlflow.start_run():
    ...
    "rag-vs-finetuning": {
      ...
      excerpt:
        "Understanding the trade-offs between Retrieval-Augmented Generation and fine-tuning for large language model applications.",
      authorId: "irina-barbos",
      ...
      image:
        "https://images.unsplash.com/photo-1655721530774-c3b96fdb8d3d?w=1200&h=600&fit=crop",
      content: [
        {
          type: "paragraph",
