...
const CaseStudyDetail = () => {
  ...
  const caseStudies: Record<string, any> = {
    "oil-gas-invoice-automation": {
      ...
      technicalApproach: [
        {
          ...
          description:
            "Data captured from email attachments or SharePoint uploads. Automated triggers created jobs to extract information from each file as it arrived.",
        },
        {
          title: "Databricks & AI Processing",
          description:
            "Specialized Databricks workflows for each file type. Used PySpark for big data processing, Azure Document Intelligence, and custom AI scripts in Python, SQL, and Scala.",
        },
        {
          title: "Data Curation Pipeline",
          description:
            "Parsed documents extracted to parquet files, then curated and written into Azure SQL Database for structured access.",
        },
        {
          title: "Business Intelligence Layer",
          description:
            "PowerBI reports created from database, enabling business teams to make data-driven decisions with actionable insights.",
        },
      ],
      results: [
        {
          icon: <TrendingUp />,
          label: "Millions in cost savings",
          detail: "Efficient technology choices and optimized implementations",
        },
        {
          icon: <Zap />,
          label: "Fully automated pipeline",
          detail: "End-to-end processing of tens of thousands of documents",
        },
        {
          icon: <Users />,
          label: "Faster business decisions",
          detail: "Data-driven insights provide competitive leverage",
        },
      ],
      additionalResults: [
      ...
      testimonial: {
        quote:
          "AI Flow delivered a production-grade data pipeline that transformed how we handle documents. The solution has saved us millions and given us the competitive edge we needed.",
      ...
      technicalApproach: [
        {
          ...
          description:
            "Leveraged Google's Vertex AI AutoML platform to automate the entire model development pipeline, from data preparation to deployment.",
        },
        {
          title: "Automated Feature Engineering",
          description:
            "AutoML system automatically identified important features and engineered new ones, eliminating months of manual experimentation.",
        },
        {
          title: "Multi-Dataset Validation",
          description:
            "Tested pipeline on two different materials science datasets to ensure robustness and generalizability of the approach.",
        },
        {
          title: "Overnight Training Pipeline",
          description:
            "Configured automated training runs that completed overnight, enabling rapid iteration and experimentation.",
        },
      ],
      results: [
        {
          icon: <Zap />,
          label: "Overnight model training",
          detail: "From 3-4 months down to overnight training runs",
        },
        {
          icon: <TrendingUp />,
          label: "Equal or better accuracy",
          detail: "AutoML models matched or exceeded manual models",
        },
        {
          icon: <Users />,
          label: "95% time reduction",
          detail:
            "Freed up researchers to focus on science, not ML engineering",
        },
      ],
      additionalResults: [
    ...
    "student-financing-platform": {
      title:
        "Rebuilding a Scalable Student Financing Platform with Next.js and Prisma",
      ...
      solutionDetail:
        "We proposed a modern full-stack architecture, choosing Next.js for the frontend, Apollo GraphQL for API communication, React for UI development, and Prisma as the ORM with a PostgreSQL database. From day one, we focused on building a robust foundation that would make future iterations fast and flexible.",
      solutionPoints: [
      ...
      technicalApproach: [
        {
          ...
          description:
            "Built with Next.js and React for optimal performance, SEO capabilities, and developer experience. Server-side rendering ensures fast page loads and excellent user experience.",
        },
        {
          title: "GraphQL API Layer",
          description:
            "Implemented Apollo GraphQL for efficient data fetching and real-time updates. Type-safe queries and mutations improved development speed and reduced bugs.",
        },
        {
          title: "Robust Database Design",
          description:
            "Used Prisma ORM with PostgreSQL for type-safe database access, automated migrations, and excellent developer tooling. Schema-first approach ensured data integrity.",
        },
        {
          title: "Low-Cost Infrastructure",
          description:
            "Deployed on Digital Ocean with optimized resource utilization. Achieved high performance without sacrificing reliability while maintaining minimal operating costs.",
        },
      ],
      results: [
        {
          icon: <Zap />,
          label: "Delivered in 3 months",
          detail: "Complete platform rebuild from scratch to production launch",
        },
        {
          icon: <Users />,
          label: "Thousands of users migrated",
          detail:
            "Seamless migration with zero data loss and minimal user disruption",
        },
        {
          icon: <TrendingUp />,
          label: "Zero downtime launch",
          detail:
            "Launched during high-traffic phase without fallback to legacy platform",
        },
      ],
      additionalResults: [
      ...
      testimonial: {
        quote:
          "AI Flow delivered a production-ready platform in just three months. The modern architecture they built has made it incredibly easy for our team to add new features and scale quickly.",
        author: "CTO",
    ...
    "google-ml-pipeline-optimization": {
      ...
      technicalApproach: [
        {
          ...
          description:
            "Pool of attention-based models trained in parallel with checkpoints every 5 features for collaborative voting. This preserved diversity while avoiding redundant feature clusters.",
        },
        {
          title: "Ensemble Feature Voting",
          description:
            "Random subspace method where each model trains on randomly masked features. Voting heatmaps identified consistently important features, improving interpretability.",
        },
        {
          title: "Data Subsampling Strategy",
          description:
            "Masks computed using 20% of data, final models trained with full dataset. Achieved 3–5x speedup in experimentation cycles while maintaining quality.",
        },
        {
          title: "SVD-based Budget Estimation",
          description:
            "Implemented SVD heuristic to estimate effective dimensionality, acting as upper bound for feature subset size and avoiding wasteful computation.",
        },
      ],
      results: [
        {
          icon: <Zap />,
          label: "65% pipeline time reduction",
          detail:
            "Parallelized models lowered total mask selection time by over 40%",
        },
        {
          icon: <TrendingUp />,
          label: "64% feature reduction",
          detail: "Reduced features with no loss in accuracy on some datasets",
        },
        {
          icon: <Users />,
          label: "90% smaller models",
          detail: "Translating to faster training and inference at scale",
        },
      ],
      additionalResults: [
      ...
      testimonial: {
        quote:
          "The feature selection tool has transformed how our teams approach high-dimensional data. We're seeing massive time savings and better models across the board.",
    ...
    "legal-intelligence-platform": {
      ...
      challengeDetail:
        "In law, each case comes with specific challenges and contextual information. Documentation ranges from text files to PDFs, scans, documents with hundreds of pages, and unstructured information. On top of this, clients want to know as fast as possible whether their case can be settled and what the approximate value is, looking at similar cases. Humans can't parse and make sense of large volumes of unstructured data in real-time. The data is often 'dirty,' needing cleaning, organization, and proper processing.",
      solution:
      ...
      technicalApproach: [
        {
          ...
          description:
            "Parsed HTML data with BeautifulSoup, removing irrelevant information like styling, tags, and scripts. Saved costs and storage by 75% by optimizing specificity percentage.",
        },
        {
          title: "RAG & Vector Store",
          description:
            "Started with FAISS for dev/staging (on-premises, zero cost testing). Moved to Pinecone index for production. Chunking strategy optimized for fact-based retrieval.",
        },
        {
          title: "LLM Inference",
          description:
            "Used Mistral on local Ollama server for dev/staging. Moved to OpenAI GPT-4o for production with temperature optimization for factual queries vs summarization.",
        },
        {
          title: "Full-Stack Application",
          description:
            "Streamlit web app with PostgreSQL on Digital Ocean, Prisma ORM, and token-based security system for quick prototype with good quality ratio.",
        },
      ],
      results: [
        {
          ...
          detail: "Near real-time answers from hundreds of pages",
        },
        {
          icon: <TrendingUp />,
          label: "75% storage reduction",
          detail: "Optimized data cleaning saved costs and improved relevance",
        },
        {
          icon: <Users />,
          label: "Delivered in 3 weeks",
          detail: "From concept to deployed POC with full authentication",
        },
      ],
      additionalResults: [
      ...
      testimonial: {
        quote:
          "AI Flow delivered a working chatbot in just 3 weeks that instantly answers questions from our massive case file library. The cost savings and speed are incredible.",
      ...
      technicalApproach: [
        {
          ...
          description:
            "BeautifulSoup and headless Chromium extract structured content from career pages and job boards, identifying new postings and summarizing with LLMs.",
        },
        {
          title: "Data Cleaning Pipeline",
          description:
            "Strip irrelevant markup (CSS, scripts) for faster and cheaper LLM inference. Similar approach used in legal tech case study, improving accuracy.",
        },
        {
          title: "LLM-Powered Analysis",
          description:
            "GPT-4-turbo interactions constrained to return consistent JSON-based schema. Real-time token monitoring with tiktoken optimizes costs and performance.",
        },
        {
          title: "Backend Infrastructure",
          description:
            "Django backend with PostgreSQL on DigitalOcean and Prisma ORM. Daily cron jobs for automated updates and monitoring.",
        },
      ],
      results: [
        {
          icon: <Zap />,
          label: "Real-time lead intelligence",
          detail: "Be first to know when companies signal buying intent",
        },
        {
          icon: <TrendingUp />,
          label: "Automated buying intent detection",
          detail: "AI extracts actionable insights from unstructured job data",
        },
        {
          icon: <Users />,
          label: "Thousands of companies monitored",
          detail: "Scale impossible for human sales teams",
        },
      ],
      additionalResults: [
    ...
    "ai-legal-risk-detection": {
      ...
      technicalApproach: [
        {
          ...
          description:
            "Assessed each page and legal issue in isolation, ensuring prompts remained focused and specific. Modular, auditable, and adaptable architecture.",
        },
        {
          title: "RAG System with Pinecone",
          description:
            "Ingested documents to review and curated dataset of legal definitions/precedents into Pinecone vector store. Retrieved definitions, context, and law references.",
        },
        {
          title: "GPT-4 Legal Analysis",
          description:
            "Structured prompt format asking if page raises concern for specific issue and why. Each page analyzed once per issue for focused interpretation.",
        },
        {
      ...
      results: [
        {
          icon: <Zap />,
          label: "Automated page-by-page analysis",
          detail: "Working prototype ready for internal legal teams",
        },
        {
          icon: <TrendingUp />,
          label: "Structured risk categorization",
          detail: "Clear outputs for rapid triage and documentation",
        },
        {
          icon: <Users />,
          label: "Scalable for large documents",
          detail: "Baseline for larger content review workflows",
        },
      ],
      additionalResults: [
      ...
      testimonial: {
        quote:
          "The POC exceeded our expectations. We can now automatically flag legal risks across hundreds of pages with clear justifications. This is exactly what we needed.",
