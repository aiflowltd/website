...
export const jobs: Record<string, Job> = {
  ...
  "full-stack-ai-engineer": {
    ...
    requirements: [
      ...
      "A genuine understanding of how LLMs work — not just how to call them — including their limitations, failure modes, and how to build reliably around them",
      "Security-conscious by default — you treat data handling, access control, and secrets management as non-negotiable, especially in regulated environments",
    ...
    benefits: [
      "100% remote — work from anywhere",
      "Freelance or full-time, your choice",
      "Real production systems inside regulated financial institutions",
