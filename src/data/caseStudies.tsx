  ...
  "exomatter-automl": {
    ...
    results: [
      ...
      },
      {
        ...
        detail: "Freed up researchers to focus on science, not ML engineering",
      },
    ],
    additionalResults: [
    ...
    results: [
      {
        ...
        detail: "Parallelized models lowered total mask selection time by over 40%",
      },
      {
        icon: <TrendingUp />,
  ...
  "student-financing-platform": {
    ...
    results: [
      ...
      },
      {
        ...
        detail: "Seamless migration with zero data loss and minimal user disruption",
      },
      {
        icon: <TrendingUp />,
...
export const mainCaseStudies = [
  ...
  caseStudies["legal-intelligence-platform"],
  caseStudies["sales-intelligence-platform"],
  caseStudies["ai-legal-risk-detection"],
